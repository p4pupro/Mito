...
export const Page01 = () => {
  ...
  return isLoading ? (
    <View style={styles.activityContainer}>
      <ActivityIndicator animating color="#6B52AF" size="large" />
    </View>
  ) : (
    <View style={styles.container}>
      <View style={styles.textContainer}>
        ...
        <Text style={styles.mito}>{t("MITO")}</Text>
        <Text style={styles.mitoDescription}>{t("MITO_DESCRIPTION")}</Text>
        <FontAwesome5
      ...
      <View style={styles.rowPicker}>
        <View style={styles.leftHeaderColunm}>
          ...
          <View style={styles.row}>
            <Text style={styles.I18N}>{t("I18N_LOCALIZATION")}</Text>
        ...
        <View style={styles.rightHeaderColunm}>
          <View style={styles.row}>
            <Text>{t("PICKER_MESSAGE")}</Text>
          </View>
          <View style={[styles.row, { marginTop: "12%" }]}>
            <Text>{t("TOOLTIP_MESSAGE")}</Text>
          </View>
          <View style={styles.row}>
            <Text>{t("I18N_MESSAGE")}</Text>
          </View>
          <View style={styles.row}>
            <Text>{t("DATETIME_MESSAGE")}</Text>
          </View>
        </View>
      </View>
    </View>
